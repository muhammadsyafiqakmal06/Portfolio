    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          imageUrl: 'indrabath',
          role: 'Fullstack Web Developer',
          status: 'Website that make easier for customers to find travel and transportation services, including information of the company’s, products or services offered, testimoni and contacts.',
        ...
        },
        {
          ...
          status: 'E-commerce website for iSeven Store Jogja, including product catalog, shopping cart, inventory management, and customer support features. ',
        ...
        },
        {
          ...
          imageUrl: 'pelsurat',
          role: 'Frontend Web Developer',
          status: 'Correspondence website to help the community take care of administrative needs to the Gilangharjo village, including administrative menu, home page, and direct contacts information.',
          tech: 'CodeIgniter 4, Bootstrap',
          github: 'null',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Login Freelance OKE GARDEN',
          imageUrl: 'okegarden1',
          role: 'Frontend Web Developer',
          status: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.',
            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full mt-1 text-normal text-sm text-left text-amber-200">
                    {{ item.role }}
                  </div>
