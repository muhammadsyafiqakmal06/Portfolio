      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Certified Junior Web Developer with experience as a Computer Lab Assistant. Skilled in Data 
Mining, Database Systems, and Web Programming with expertise in PHP, HTML/CSS, 
JavaScript, and SQL. Experienced in delivering practical training, guiding others through web 
development processes, and collaborating effectively in team environments. Dedicated to 
continuous learning and tackling new challenges with enthusiasm
          </p>
